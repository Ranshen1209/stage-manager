...
0.3.15 通过 255 项逻辑测试、Release 构建和 XAML 静态检查，新增覆盖 4K / 150% 物理屏关闭后换为 1080p / 100% 虚拟屏、大窗口收缩、可读尺寸优先、最大化保留、连续往返及升级时纠正旧版过大布局。本版未运行窗口、真实游戏、DPI 切换或远程连接测试；实际效果受应用最小尺寸及显示驱动行为影响。
