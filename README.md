...
- **远程切屏保护**：物理屏与远程虚拟屏切换时等待状态稳定，保留整体迁移的分组、名称和成员顺序。
...
当前版本为 **[0.3.7](https://github.com/Ranshen1209/stage-manager/releases/tag/v0.3.7)**，更新内容见 [版本记录](docs/changelog.zh-CN.md)。
...
0.3.7 通过 172 项逻辑测试、Release 构建和 XAML 静态检查。本版未运行窗口或真实键鼠交互测试，拖动视觉效果及快捷键录入的系统交互仍需实际使用验证。
