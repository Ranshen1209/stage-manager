...
- **拖动整理**：将窗口或卡片拖入分组、移出分组；侧栏拖动时支持边缘滚动。
- **保留所选窗口**：从任务栏或 Alt+Tab 切换到组内成员时，保留它的焦点与前台层级。
- **可调侧栏**：最窄支持 180 个逻辑像素，记住位置与大小；贴边后可自动收起，鼠标移到屏幕边缘再展开。
...
- **托盘与快捷键**：自定义全局快捷键并检测注册冲突；可选关闭后后台运行、自启和静默启动。
- **记住布局**：重启本应用后恢复仍然打开的窗口分组、位置与最近成员；退出时恢复接管前的布局。

## 开始使用

当前修复版为 **[0.3.1](https://github.com/Ranshen1209/stage-manager/releases/tag/v0.3.1)**，更新内容见 [版本记录](docs/changelog.zh-CN.md)。
