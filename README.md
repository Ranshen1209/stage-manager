...
当前版本为 **[0.3.17](https://github.com/Ranshen1209/stage-manager/releases/tag/v0.3.17)**，更新内容见 [版本记录](docs/changelog.zh-CN.md)。
...
0.3.17 的普通构建与混淆加壳后的 EXE 均通过 280 项逻辑测试，并完成 XAML 静态检查。新增覆盖后台异步请求未生效、恢复后的二次 DPI 调整、横屏 / 竖屏 / 超宽屏比例、应用最小高度、有限纠正、跨重启保留基准，以及手动调整和分屏平铺优先。按要求未运行窗口、真实 DPI 切换或远程连接测试；实际效果仍受应用最小尺寸及显示驱动行为影响。
