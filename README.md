...
当前版本为 **[0.3.11](https://github.com/Ranshen1209/stage-manager/releases/tag/v0.3.11)**，更新内容见 [版本记录](docs/changelog.zh-CN.md)。
...
在 **“设置 → 窗口行为”** 中可开启 **“Win+D 显示桌面时保留侧栏”**，默认关闭。开启后仅侧栏保留，其他应用仍正常显示桌面；切回总览后恢复普通窗口行为，不影响关闭到托盘、全屏避让和贴边自动收起。
